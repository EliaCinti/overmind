...
## M9 — Overmind as MCP server `in-progress`
The server itself exists: [ADR-0027](adr/0027-agents-reach-memory-through-overmind.md) built it for M8 slice 3, and every caged run already goes through it. What remains is the rest of the surface and the external caller.
