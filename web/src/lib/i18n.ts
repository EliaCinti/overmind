...
export const en = {
  ...
  chat: {
    ...
    activityTool: "Using {tool}…",
    activityThinking: "Thinking…",
    activityWriting: "Writing…",
    activityToolOf: "Using {tool} ({server})…",
  ...
  inbox: {
    ...
    toastMore: "{n} more waiting — open the inbox",
  ...
  backup: {
    title: "Backups",
    body: "An archive is this whole instance — the database, every company's memory, its attachments, and (sealed) its sign-in. Keep it somewhere this disk isn't.",
    export: "Export now",
    download: "Download",
    kept: "Kept on this server",
    none: "No archive yet.",
    delete: "Delete",
    deleteConfirm: "Delete for good",
    passphrase: "Passphrase",
    passphraseHint: "At least 12 characters. This is what protects the sign-in inside the archive once it leaves this machine.",
    passphrasePlaceholder: "A passphrase only you know",
    restoreHint: "To bring an archive back, start from an empty instance and choose Restore on its first screen.",
    restoreTitle: "Restore an archive",
    restoreBody: "This instance is empty, so it can take an archive whole — its companies, its memory, its history. Once anything is claimed, this option is gone.",
    restoreChoose: "Choose an archive…",
    restoreChosen: "Chosen: {name}",
    restoreSealed: "This archive's sign-in is sealed. Give the passphrase it was exported with, or restore without it.",
    restoreSkipToken: "Restore without the sign-in",
    restoreGo: "Restore",
    restoreWorking: "Restoring…",
    restoreDone: "Restored. This Overmind is restarting on the recovered data — reload in a moment.",
    restoreBack: "Back",
  },
  economy: {
  ...
  org: {
    ...
    monthlyCap: "Monthly cap (€ — equivalents under a plan)",
    tools: "Tools",
    toolsHint: "Granted here, held from the next run on. Only what the operator declared on this machine.",
    toolsSaved: "Tools updated.",
    holds: "Holds: {tools}",
    youOwner: "You (owner)",
...
export const it: Dictionary = {
  ...
  chat: {
    ...
    activityTool: "Sta usando {tool}…",
    activityThinking: "Sta ragionando…",
    activityWriting: "Sta scrivendo…",
    activityToolOf: "Sta usando {tool} ({server})…",
    activityText: "«{preview}»",
  ...
  inbox: {
    ...
    toastMore: "Altre {n} in attesa — apri l'Inbox",
  ...
  backup: {
    title: "Backup",
    body: "Un archivio è questa istanza intera — il database, la memoria di ogni azienda, gli allegati e (sigillato) il suo accesso. Tienilo altrove, non solo su questo disco.",
    export: "Esporta ora",
    download: "Scarica",
    kept: "Conservati su questo server",
    none: "Nessun archivio ancora.",
    delete: "Elimina",
    deleteConfirm: "Elimina definitivamente",
    passphrase: "Passphrase",
    passphraseHint: "Almeno 12 caratteri. È ciò che protegge l'accesso dentro l'archivio una volta uscito da questa macchina.",
    passphrasePlaceholder: "Una passphrase che conosci solo tu",
    restoreHint: "Per riportare indietro un archivio, parti da un'istanza vuota e scegli Ripristina nella sua prima schermata.",
    restoreTitle: "Ripristina un archivio",
    restoreBody: "Questa istanza è vuota, quindi può accogliere un archivio intero — le sue aziende, la sua memoria, la sua storia. Appena qualcosa viene reclamato, questa opzione sparisce.",
    restoreChoose: "Scegli un archivio…",
    restoreChosen: "Scelto: {name}",
    restoreSealed: "L'accesso di questo archivio è sigillato. Dai la passphrase con cui è stato esportato, oppure ripristina senza.",
    restoreSkipToken: "Ripristina senza l'accesso",
    restoreGo: "Ripristina",
    restoreWorking: "Ripristino…",
    restoreDone: "Ripristinato. Questo Overmind si sta riavviando sui dati recuperati — ricarica tra poco.",
    restoreBack: "Indietro",
  },
  economy: {
  ...
  org: {
    ...
    monthlyCap: "Tetto mensile (€ — equivalenti sotto abbonamento)",
    tools: "Strumenti",
    toolsHint: "Concessi qui, in mano dal prossimo run. Solo ciò che l'operatore ha dichiarato su questa macchina.",
    toolsSaved: "Strumenti aggiornati.",
    holds: "Ha: {tools}",
