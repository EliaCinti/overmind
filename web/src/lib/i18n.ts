...
export const en = {
  ...
  economy: {
    ...
    connectPlanRejected: "The CLI did not accept that code. Open the link again if needed, and paste a fresh code — each one works once.",
    left: "{pct}% left",
    ofCap: "{used} of {cap}",
...
export const it: Dictionary = {
  ...
  economy: {
    ...
    connectPlanRejected: "La CLI non ha accettato il codice. Riapri il link se serve e incolla un codice nuovo — ognuno vale una volta sola.",
    left: "{pct}% rimasto",
    ofCap: "{used} di {cap}",
