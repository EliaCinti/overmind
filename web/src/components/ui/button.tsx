  ...
  ({ className, variant = "secondary", size = "md", ...props }, ref) => (
    <button
      ...
      className={cn(
        ...
        // The door's language, app-wide (owner's word): round, and answering
        // the hand -- a soft lift on hover, a press you can feel.
        "inline-flex items-center justify-center whitespace-nowrap rounded-full font-medium",
        "transition-[transform,background,border-color,box-shadow,color] duration-150",
